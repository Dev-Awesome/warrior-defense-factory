...
{
    // This is a simple AI for making all things more fun.
    ...
    protected CharacterStrategy character;
    protected CharacterStrategy followingCharacter;

    protected GameObject following {
        get {
